    ...
    <>
      <header className="facebook-header">
        <div className="header-left">
          <div className="logo">
            <svg viewBox="0 0 36 36" fill="#0866FF" height="40" width="40">
      ...
      <main className="facebook-main">
        <div className="facebook-sidebar-left">
          <img src={`${publicUrl}/assets/img/channels/fb-sidebar-left-icons.png`} alt="sidebar" />
          <ul>
        ...
        <div className="facebook-feed">
          <div className="post-box new-post">
            ...
            <div className="post-types">
              <button>
                <img src={`${publicUrl}/assets/img/channels/fb-video.png`} alt="Live video" /> Live
                video
              </button>
              <button>
                <img src={`${publicUrl}/assets/img/channels/fb-photo.png`} alt="Photo/video" />
                Photo/video
              </button>
              <button>
                <img
                  src={`${publicUrl}/assets/img/channels/fb-feeling.png`}
