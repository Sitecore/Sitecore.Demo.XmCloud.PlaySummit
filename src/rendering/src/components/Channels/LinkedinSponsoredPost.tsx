...
type LinkedinSponsoredPostProps = {
  postContent: string;
  postWebpage: string;
...
const LinkedinSponsoredPost = ({
  ...
  comments,
  shares,
}: LinkedinSponsoredPostProps): JSX.Element => {
...
export default LinkedinSponsoredPost;
